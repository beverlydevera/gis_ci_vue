                    ...
                    <table class="table-sched">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="3" class="fill-gray stroke-text">Open Mats</td>
                                <td rowspan="6" class="fill-gray stroke-text">Open Mats</td>
                                <td rowspan="3" class="fill-semi-orange"><a href="class_schedule.php"><span class="stroke-text">Level 1 Regular and Gear Drills 10 & Below</span></a></td>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" class="fill-dark-orange"><a href="class_schedule.php"><span class="stroke-text">Level 2 Regular and Gear Drills 10 & Below</span></a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" class="fill-gray stroke-text">Lunch Break</td>
                                <td rowspan="2" class="fill-gray stroke-text">Lunch Break</td>
                                <td rowspan="3" class="fill-dark-blue"><a href="class_schedule.php"><span class="stroke-text">All Levels Regular and Gear Drills Teen Class</span></a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" class="fill-semi-orange hoverable"><a href="class_schedule.php"><span class="stroke-text">All Levels Regular Class</span></a></td>
                                ...
                                <td rowspan="3" class="fill-semi-orange"><a href="class_schedule.php"><span class="stroke-text">All Levels Regular and Gear Drills</span></a></td>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" class="fill-semi-orange"><a href="class_schedule.php"><span class="stroke-text">All Levels Regular and Gear Drills</span></a></td>
                                <td rowspan="3" class="fill-dark-violet"><a href="class_schedule.php"><span class="stroke-text">Blackbelts Special Training</span></a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td rowspan="3" class="fill-yellow"><a href="class_schedule.php"><span class="stroke-text">All Levels High Intensity Gears Requierd</span></a></td>
                                <td rowspan="3" class="fill-semi-orange"><a href="class_schedule.php"><span class="stroke-text">All Levels Regular and Gear Drills</span></a></td>
                                <td class="fill-gray"><a href="class_schedule.php"><span class="stroke-text">Blackbelts Club</span></a></td>
